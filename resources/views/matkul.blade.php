            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4>Data Mata Kuliah
                        ...
                        <a onclick="addForm()" class="btn btn-primary pull-right" style="margin-top: -8px;">Add Matkul</a>

                       
                    </h4>
                </div>
                <div class="panel-body">
                    <table id="matkul-table" class="table table-striped">
                        <thead>
                            <tr>
                                <th>Mata Kuliah</th>
                                <th>Action</th>
...
$(document).ready(function() {
    ...
    var validator= $('#modal-form form').validator();
        ...
        if (!e.isDefaultPrevented()) {
            ...
            if (save_method == 'add') url = "{{ url('matkul') }}";
            else url = "{{ url('matkul') . '/' }}" + id;
