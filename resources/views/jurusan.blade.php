            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4>Data Jurusan
                        ...
                        <a href="{{ route('jurusan.export') }}" class="btn btn-success pull-right" style="margin-top: -8px;"><i class="fa fa-print"></i> Unduh</a>
                    
                    </h4>
                </div>
                <div class="panel-body">
                    <form method="post" enctype="multipart/form-data" action="{{ route('jurusan.import')}}" class="form-horizontal">
                        {{ csrf_field() }}
